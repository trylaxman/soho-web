...
export default async function BookingDetailPage({
  ...
  const latestPayment = booking.payments[0] as BookingPayment | undefined;
          ...
          <Panel title="Cleaning Details">
            <InfoGrid
              items={[
                ...
                ["Add-On Total", `$${booking.addOnTotal.toFixed(2)}`],
          ...
          <Panel title="Payment Status">
            {!latestPayment ? (
              ...
              <div className="space-y-5">
                ...
                <PaymentStatusMessage status={latestPayment.status} />
                  ...
                  >
                    ...
                    <div className="mt-5 space-y-3 border-t border-[#2f291d] pt-5 text-xs text-[#8f8778]">
                      <p className="break-all">
                        ...
                        {payment.paymentIntentId || "Not available"}
                      </p>
                      ...
                      <p className="break-all">
                        ...
                        {payment.checkoutSessionId || "Not available"}
                      </p>
                    </div>
                  </div>
                ))}
...
function PaymentStatusMessage({
  ...
  return (
    <div
      className={`rounded-[20px] border p-4 ${message.className}`}
    >
